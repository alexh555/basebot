...
def receive_new_frame(data_dict):
    ...
    # Try tracking markers
    if "labeled_markers" in data_dict:
        for (pos, marker_id) in data_dict["labeled_markers"]:
            print(f"Marker {marker_id} → Position: {pos}")
...
if __name__ == "__main__":
    ...
    optionsDict["serverAddress"] = "172.24.68.77"
